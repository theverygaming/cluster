      ...
      tiny = nixpkgs.lib.nixosSystem {
        ...
        modules = [
          ...
          ({ lib, config, pkgs, ... }: {
            ...
            # ideally these would be entirely gone but i couldn't figure out how to do that
          ...
          ({ lib, pkgs, ... }: {
            ...
            environment.systemPackages = lib.mkForce [ pkgs.coreutils pkgs.findutils pkgs.bash pkgs.ncdu ];
